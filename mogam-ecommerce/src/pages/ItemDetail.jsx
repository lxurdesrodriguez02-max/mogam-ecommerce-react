      ...
      <div className="detalle-contenedor" style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap', backgroundColor: 'white', padding: '2rem', borderRadius: '8px', border: '1px solid #e0e0e0' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          <div>
            ...
            <button className="add-to-cart" onClick={() => agregarAlCarrito(producto, 1)} style={{ width: '100%', padding: '1rem', backgroundColor: '#212529', color: 'white', border: 'none', borderRadius: '4px', fontSize: '1.1rem', cursor: 'pointer' }}>
